...
export const communitySchemaSql = `CREATE TABLE board_posts (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
// AI runs are separate from human completion records. Migration: 0011.
export const aiSchemaSql = `CREATE TABLE IF NOT EXISTS ai_sessions (
  id TEXT PRIMARY KEY,
