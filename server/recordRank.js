...
export async function clearRecordRank(db, recordId, afterId = 0) {
  return db.prepare(`SELECT r.completion_id AS recordId,r.app_version AS appVersion,r.ruleset_version AS rulesetVersion,
...
export async function trialRecordRank(db, recordId) {
  return db.prepare(`SELECT r.score_id AS recordId,r.app_version AS appVersion,r.ruleset_version AS rulesetVersion,
