...
const content = {
    trial: ["現金＋強化への投資で、30分後の総資産を競う。", "AUTOがONの間は、賭け金不足でも時計が進み、WORKできます。OFFにすると時計・WORK・FLIP・スピンが止まります。ポジション変更と強化購入はいつでもできます。", "通常モードのセーブは別に残ります。"],
